...
def get_args_parser():
    ...
    parser.add_argument('--if_download', default=True, type=bool, help="""Whether to download the dataset or not.""")
...
def train_SPQ(args):
    ...
    print('\033[91m' + '%d'%N_bits +  '-bit to retrieval' + '\033[0m'+'1')
    ...
    for epoch in range(1000):  # loop over the dataset multiple times
        ...
        for i, data in enumerate(trainloader, 0):
            ...
            if (i+1) % 10 == 0:    # print every 10 mini-batches
                print('[%3d] loss: %.4f, mAP: %.4f, MAX mAP: %.4f' %(i+1, running_loss / 10, mAP, MAX_mAP))
                running_loss = 0.0
